...
from routers import auth, users, feedback, student_feedback, docurag, analytics, chat, memory
...
app.include_router(docurag.router, prefix="/api/rag", tags=["RAG Search"])
app.include_router(docurag.router, prefix="/rag", tags=["RAG Search Fallback"]) # Vercel Fallback
