...
from services.chat_service import (
    cleanup_old_messages as cleanup_expired_messages,
    create_message,
    delete_own_message,
    list_recent_messages,
)
from services.hindsight_service import retain_chat_message
...
async def send_message(
    ...
    try:
        ...
        background_tasks.add_task(retain_chat_message, current_user, payload.message)
        return msg
...
async def cleanup_messages_endpoint():
    ...
    try:
        sb = get_supabase()
        deleted = cleanup_expired_messages(sb, lifetime_hours=1)
